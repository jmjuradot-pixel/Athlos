    ...
    <PageLayout>
      ...
      <form onSubmit={submit}>
        ...
        <div className="mt-6 flex items-center gap-4">
          ...
          <SyncButton table="workout_sessions" label="entrenamientos" localStorageKey="athlos-workouts" onConflict={undefined} transformRecord={(r: any) => ({ recorded_at: r.recordedAt, duration: r.duration ?? null, volume: r.volume ?? null, muscle_groups: r.muscleGroups ?? [], exercises: r.exercises ?? null })} />
        </div>
      </form>
